...
public class TrainningRequestSelect implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) {
		...
		vo = ms.trainningRequestSelect(vo);
		request.setAttribute("trainning", vo);
		
		return "serviceRegist/trainningRequestSelect";
	}
