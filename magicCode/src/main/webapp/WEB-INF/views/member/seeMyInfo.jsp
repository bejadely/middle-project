				...
				<div class="panel panel-info"  style="max-width: 250px" >
					...
					<div class="panel-heading">
						<h3 class="panel-title">&nbsp;Kategorie</h3>
							...
							<a href="seeMyInfo.do">내 정보 조회</a></li>
							<c:if test="${auth eq 'N'}">
							<li class="list-group-item">
							<a href="userSitterApplyAllList.do">마이 펫 돌보미 신청 현황</a></li>
							<li class="list-group-item">
							<a href="userTrainningApplyAllList.do">마이 펫 훈련 신청 현황</a></li>
							<li class="list-group-item">
							<a href="userGrommingApplyAllList.do">마이 펫 미용 신청 현황</a></li>
							</c:if>
							<c:if test="${auth eq 'S'}">
							<li class="list-group-item">
							<a href="sitterRequestHistory.do">돌봄 서비스 요청 내역 조회</a></li>
							</c:if>
							<c:if test="${auth eq 'T'}">
							<li class="list-group-item">
							<a href="trainningRequestHistory.do">훈련 서비스 요청 내역 조회</a></li>
							</c:if>
							<c:if test="${auth eq 'G'}">
							<li class="list-group-item">
							<a href="grommingRequestHistory.do">미용 서비스 요청 내역 조회</a>
							</c:if>
							</ul>
						</div>
					</aside>
