		...
		<div class="row">
			...
			<div align="center" class
				...
				<form id="frm" action="updateMyInfoForm.do" method="post">
					<div>
						<label>아이디</label> <input type="email" id="memberId"
							name="memberId" value="${id}" readonly> <label>닉네임</label>
						<input type="text" id="memberNick" name="memberNick"
							value="${nick}" readonly> <label>비밀번호</label> <input
							type="password" id="memberPw" name="memberPw" readonly> <label>이름</label>
						<input type="text" id="memberName" name="memberName"
							value="${name}" readonly> <label>연락처</label> <input
							type="text" id="memberTel" name="memberTel" value="${tel}"
							readonly> <label>주소</label> <input type="text"
							id="memberAddr" name="memberAddr" value="${addr}" readonly>
