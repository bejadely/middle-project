...
<body>
			...
			<aside class="col-4" style="max-width: 20%">
				...
				<div class="panel panel-info" style="max-width: 250px">
					...
					<ul class="list-group">
						...
						<c:if test="${auth eq 'G'}">
							<li class="list-group-item"><a
								href="grommingRequestHistory.do">미용 서비스 요청 내역 조회</a></c:if>
	...
	<div align="center" class="col-8"
		...
		<form id="frm" action="memberUpdate.do" method="post">
			<div>	
				<label>아이디</label>
				<input type="email" id="memberId" name="memberId" value="${id}" readonly style="background-color: gray;">
				<label>닉네임</label>
				<input type="text" id="memberNick" name="memberNick" value="${nick}" readonly style="background-color: gray;">
				<label>비밀번호</label>
				<input type="password" id="memberPw" name="memberPw" value="${pw}">
				<label>이름</label><br>
				<input type="text" id="memberName" name="memberName" value="${name}" readonly style="background-color: gray;">
				<label>연락처</label>
				<input type="text" id="memberTel" name="memberTel" value="${tel}">
				<label>주소</label><br>
				<input type="text" id="memberAddr" name="memberAddr" value="${addr}">
