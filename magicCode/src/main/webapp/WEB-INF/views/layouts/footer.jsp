		...
		<footer class="footer">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
						<h2 class="footer-heading">Tips for living with Pet</h2>
						...
						<div class="block-21 mb-4 d-flex">
							<a class="img mr-4 rounded"
								style="background-image: url(images/푸들.jpg);"></a>
							<div class="text">
								<h3 class="heading">
					...
					<div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0">
						...
						<ul class="list-unstyled">
							...
							<li><a href="memberInsertForm.do" class="py-2 d-block">Member
									Join</a></li>
					...
					<div class="col-md-6 col-lg-3 mb-4 mb-md-0">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon fa fa-map"></span><span class="text">Yedam
										Ac, Daegu, Korea</span></li>
								<li><a href="#"><span class="icon fa fa-phone"></span><span
										class="text">+81 053-421-2460</span></a></li>
								<li><a href="#"><span class="icon fa fa-paper-plane"></span><span
										class="text">info@withPuppy.com</span></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="row mt-5">
					<div class="col-md-12 text-center">
						...
						<p class="copyright">
							...
							by <a href="https://colorlib.com" target="_blank">magicCode</a>
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
					</div>
				</div>
