...
<body>
	...
	<div>
		<form id = "frm" action="serviceRegist.do" onsubmit="return formCheck()" method = "post" enctype="multipart/form-data">
			<div>
			...
			<div>
				...
				<input type="button" onclick="location.href='sitterAllList.do'" value="목록으로 이동">
			</div>
		</form>
	</div>	
</body>
