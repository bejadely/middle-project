 ...
 <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        <h3 class="mb-3">훈련 서비스 예약신청</h3>
        <form id = "frm" action="trainnerServiceRegist.do" method = "post">
		...
		<h4 class="mb-3">서비스 신청 내용</h4>
          <div class="row">
           ...
           <div class="row">
           	 <div class="col-md-6 mb-3">
           	    <label>훈련 서비스 예약 시간을 선택해 주십시오.</label><br>
          ...
          <div align="center">
			...
			<input type="button" class="btn btn-light" onclick="location.href='trainnerAllList.do'" value="목록으로 이동">
		  </div>
        </form>
      </div>
    </div>
